...
# user_id = 'd30e18323f15426c3cdc8585252ed34459916f51'
...
print "Hit: ", list(set(reco_list) & set(hidden_list))

precision = float(len(set(reco_list) & set(hidden_list))) / float(len(reco_list))
